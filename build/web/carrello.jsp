...
<div class="content">        
    <form action="ordine.jsp"  method="get">
            <table border="0">    
                <tr><td><h1>Ciao <% out.println( cookies[2].getValue());%></H1> </td></tr>
                <tr><td><h3>Vuoi aggiungere al carrello?</h3></td></tr>
                <tr><td align="center"><%=a.getArt_nome()%></td></tr>
          <tr><td align="center"><img src="images/<%=a.getArt_categ()%>.jpg" ></td></tr>

                

<tr><td><br></td></tr>
                
                <tr><td>Prezzo: <%=a.getArt_prezzo()%> €</td>
                <td><input type="number" name="qty" min="1" max="10" value="1"></td>
                <td><input type="submit" value="Aggiungi"></td>        
                </tr>        
        </table>
        <input type="hidden" name="art_id" value= <%=a.getArt_id()%> >
...
<!-------------- ELENCO CARRELLO ---------------------->
        <table width="630px" border="0">   
            <tr><td colspan="5"><h2>Articoli nel carrello: </h2></td></tr>
        <%      if(items.length==0){%>   <tr><td><h1>Carrello Vuoto </h1></td></tr>  <%}%>
<%
...
<td width="10px" align="right">
    ...
    <td width="30px"><% out.print(items[j].getItem_prezzo()); %> €</td>      
<%  
          totale = totale + (qty*prezzo);
        
        } %>
</tr>
<tr><td ><h2>Totale: </h2></td><td width="50px"><h3><%= totale %> €</h3></td></tr>
</table>
...
<table border="0" width="300px">
    <tr><td>
        <table>
            <tr><td><a href="index.jsp"><img align="center" src="images/icona-home-page2.jpg" width="70px" height="70px"></td></tr>                
